...
import { IoIosHome,  IoMdSpeedometer, IoMdPerson } from "react-icons/io"; // Import the necessary icons
...
const SubNavbar = () => {
    ...
    return (
        <motion.nav
            className={`fixed top-0 left-0 w-full z-50 ${open?"bg-black":"bg-red-700"}   shadow-lg`}
            animate={controls}
        ...
        >
            <div className=" container mx-auto py-0 flex flex-col md:flex-row justify-between items-center">
                ...
                <Link to={'/card'} className=" flex items-center">
                    <FaCartShopping className="text-xl text-whie" />
